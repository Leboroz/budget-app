...
ActiveRecord::Schema[7.0].define(version: 2022_05_24_184102) do
  ...
  create_table "group_transactions", force: :cascade do |t|
    ...
    t.index ["payment_id"], name: "index_group_transactions_on_payment_id"
  end
  ...
  add_foreign_key "group_transactions", "payments"
